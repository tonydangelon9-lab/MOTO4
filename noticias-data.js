/* ============================================================
   NOTICIAS — Mobil Moto4 Latin Cup
   ============================================================
   CÓMO AGREGAR UNA NOTICIA (desde GitHub web, botón del lápiz):
   1. Copia un bloque completo { ... }, del { al },
   2. Pégalo ARRIBA del primero (la más nueva va primero)
   3. Edita los campos. La fecha va AAAA-MM-DD.
   4. "imagen": usa una foto de la carpeta MEDIA-fotos-listas/
      o cualquier URL. Si no tienes foto, deja "" y la tarjeta
      muestra el degradado morado con el logo.
   5. Commit changes. Listo — aparece sola con etiqueta NEW
...
window.NOTICIAS = [
  ...
  },
  {
    ...
    bajada: "En el paddock, la previa de cada carrera.  🤝 Mobil · Honda · Pirelli · SMK Helmets · Aquiles · Impovar · Revemar · FIM Latin America #Moto4LatinCup #RoadToMotoGP #SanNicolas #Cami",
    imagen: "NOTICIAS-IG/Dcekr_znGbQ.jpg",
    ig: "Dcekr_znGbQ",
    cuerpo: "En el paddock, la previa de cada carrera.<br><br>🤝 Mobil · Honda · Pirelli · SMK Helmets · Aquiles · Impovar · Revemar · FIM Latin America<br>#Moto4LatinCup #RoadToMotoGP #SanNicolas #CaminoAVillicum"
  },
  {
    fecha: "2026-08-24",
    categoria: "Instagram",
  ...
  },
  {
    ...
    bajada: "⏱️ D-25 | RUMBO A VILLICUM 🇦🇷  La parrilla completa su cuenta regresiva: Gael Olivo (#15, Mexico) esta confirmado para las Rounds 7-8-9 en el Circuito San Juan Villicum — P16",
    imagen: "NOTICIAS-IG/Db3F0nflgUt.jpg",
    ig: "Db3F0nflgUt",
    cuerpo: "⏱️ D-25 | RUMBO A VILLICUM 🇦🇷<br><br>La parrilla completa su cuenta regresiva: Gael Olivo (#15, Mexico) esta confirmado para las Rounds 7-8-9 en el Circuito San Juan Villicum — P16 del ranking de la Mobil Moto4 Latin Cup.<br><br>🇬🇧 25 days to go! The grid completes its countdown: Gael Olivo (#15, Mexico) is confirmed for Rounds 7-8-9 at Circuito San Juan Villicum — P16 in the Mobil Moto4 Latin Cup standings.<br><br>🤝 Mobil · Honda · Pirelli · SMK Helmets · Aquiles · Impovar · Revemar · FIM Latin America<br><br>#Moto4LatinCup #RoadToMotoGP #Villicum #SanJuan #Mobil"
  },
  {
    fecha: "2026-08-09",
    categoria: "Instagram",
  ...
  },
  {
    ...
    categoria: "Instagram",
    titulo: "⚡ EN ACCIÓN | RUMBO A VILLICUM 🇦🇷",
    bajada: "⚡ EN ACCIÓN | RUMBO A VILLICUM 🇦🇷  Santiago Gossa (#11, Argentina) ataca en su tierra — P7 del ranking con 49 puntos, confirmado para las Rounds 7-8-9 en Villicum.  🇬🇧 Santiago",
    imagen: "NOTICIAS-IG/DbrEysoHB_X.jpg",
    ig: "DbrEysoHB_X",
    cuerpo: "⚡ EN ACCIÓN | RUMBO A VILLICUM 🇦🇷<br><br>Santiago Gossa (#11, Argentina) ataca en su tierra — P7 del ranking con 49 puntos, confirmado para las Rounds 7-8-9 en Villicum.<br><br>🇬🇧 Santiago Gossa (#11, Argentina) attacks on home soil — P7 in the standings with 49 points.<br><br>🤝 Mobil · Honda · Pirelli · SMK Helmets · Aquiles · Impovar · Revemar · FIM Latin America<br><br>#Moto4LatinCup #RoadToMotoGP #Villicum #SanJuan #Mobil"
  },
  {
    fecha: "2026-08-05",
    categoria: "Instagram",
  ...
  },
  {
    ...
    categoria: "Instagram",
    titulo: "⚡ EN ACCIÓN | RUMBO A VILLICUM 🇦🇷",
    bajada: "⚡ EN ACCIÓN | RUMBO A VILLICUM 🇦🇷  Pura inclinación: Murilo Gomes (#42, Brasil) — P9 del ranking con 34 puntos, confirmado para las Rounds 7-8-9 en Villicum.  🇬🇧 Leaning it in:",
    imagen: "NOTICIAS-IG/Dbl7MJ_Guw_.jpg",
    ig: "Dbl7MJ_Guw_",
    cuerpo: "⚡ EN ACCIÓN | RUMBO A VILLICUM 🇦🇷<br><br>Pura inclinación: Murilo Gomes (#42, Brasil) — P9 del ranking con 34 puntos, confirmado para las Rounds 7-8-9 en Villicum.<br><br>🇬🇧 Leaning it in: Murilo Gomes (#42, Brazil) — P9 in the standings with 34 points, confirmed for Rounds 7-8-9 at Villicum.<br><br>🤝 Mobil · Honda · Pirelli · SMK Helmets · Aquiles · Impovar · Revemar · FIM Latin America<br><br>#Moto4LatinCup #RoadToMotoGP #Villicum #SanJuan #Mobil"
  },
  {
    fecha: "2026-08-03",
    categoria: "Instagram",
...

  {
    ...
    bajada: "La marca global de lubricantes se convierte en title sponsor del campeonato oficial FIM Latin America dentro del programa Road to MotoGP.",
    imagen: "PRESENTACION/moto_real_2026.jpg",
    cuerpo: "El campeonato Moto4 Latin Cup incorpora a <b>Mobil</b> como title sponsor para la temporada 2026: el certamen pasa a denominarse oficialmente <b>Mobil Moto4 Latin Cup</b>.<br><br>La marca acompaña cada detalle del campeonato: presencia estelar en el carenado de las 16 Honda NSF250R de la grilla, en los trajes de los pilotos, en la estructura de boxes y en toda la comunicación oficial del certamen que corre en Brasil y Argentina junto al Moto1000GP, al GP3-CAV y al Mundial de MotoGP.<br><img src=\"PRESENTACION/moto_real_2026.jpg\" style=\"width:100%;border-radius:12px;margin:14px 0\" alt=\"La Honda NSF250R oficial con los colores de Mobil\"><br>Con décadas de historia en el automovilismo y el motociclismo mundial, Mobil se suma al proyecto que lleva a los jóvenes talentos latinoamericanos rumbo a MotoGP — el mismo modelo que en Asia acompaña la petrolera Idemitsu como title sponsor de la Moto4 Asia Cup, una de las principales canteras del Mundial.<br><br>La alianza refleja la apuesta de las grandes marcas por el motociclismo latinoamericano, la región de mayor crecimiento del mundo en dos ruedas.<br><img src=\"PRESENTACION/foto_grupal_2026.jpg\" style=\"width:100%;border-radius:12px;margin:14px 0\" alt=\"El equipo completo de la Mobil Moto4 Latin Cup\"><br>"
  },

  {
    fecha: "2026-07-03",
    categoria: "Campeonato",
    titulo: "San Juan Villicum recibe la Moto4 Latin Cup: rondas 7, 8 y 9",
    bajada: "Del 4 al 6 de septiembre el circuito El Villicum será sede de la triple ronda argentina junto al GP3-CAV.",
    imagen: "",
    cuerpo: "La Mobil Moto4 Latin Cup llega en septiembre al Circuito San Juan Villicum para las rondas 7, 8 y 9 de la temporada 2026. <br><br>Tras el paso por San Nicolás, los pilotos del camino latino al MotoGP afrontan la segunda cita argentina del año en uno de los trazados más modernos de Sudamérica, escenario habitual del motociclismo internacional. <br><br>Kensei Matsudaira (USA) llega como líder del campeonato con 113 puntos, seguido por Alberto Enríquez (ECU) y Andoni Domínguez (NIC)."
  },

  {
    fecha: "2026-06-22",
    categoria: "Resultados",
    titulo: "Matsudaira, Domínguez y Enríquez, los ganadores de San Nicolás",
    bajada: "Tres carreras y tres vencedores diferentes en las fechas 4, 5 y 6 disputadas en el Autódromo Juan María Traverso junto al GP3-CAV.",
    imagen: "PRESENTACION/podio_alberto.jpg",
    cuerpo: "El Campeonato Moto4 Latin Cup, del programa Road to MotoGP, corrió sus fechas 4, 5 y 6 en el Autódromo “Juan María Traverso” de San Nicolás de los Arroyos, Buenos Aires, Argentina. En las tres competencias disputadas entre el sábado 20 y el domingo 21 de junio hubo tres vencedores diferentes.<br><br>En la competencia del sábado ganó por primera vez el norteamericano <b>Kensei Matsudaira</b>. El palestino Mahdi Salem logró el 2° puesto y el subcampeón 2025, el argentino Santiago Gossa, alcanzó el 3° lugar y su primer podio del año. Esta carrera correspondía a la fecha pendiente de Goiânia.<br><img src=\"PRESENTACION/podio_mat.jpg\" style=\"width:100%;border-radius:12px;margin:14px 0\" alt=\"Podio del sábado en San Nicolás\"><br>El domingo se disputaron las dos finales de las rondas 5 y 6. En la primera, del mediodía, la lucha fue entre seis pilotos y la victoria — segunda del año — fue para el nicaragüense <b>Andoni Domínguez</b>. Kensei Matsudaira fue segundo y nuevamente el palestino Mahdi Salem subió al podio en tercer lugar. En esta final fueron al suelo sin consecuencias Murilo Gomes, el poleman, y el ecuatoriano líder del campeonato Alberto Enríquez.<br><img src=\"PRESENTACION/podio_andoni.jpg\" style=\"width:100%;border-radius:12px;margin:14px 0\" alt=\"Podio de la ronda 5\"><br>En la carrera de la tarde fueron ocho los pilotos que pelearon por la victoria y terminaron dentro del segundo en la bajada de la bandera de cuadros. La revancha fue para <b>Alberto Enríquez</b>, que no había podido sumar en la final anterior y fue 4° en la del sábado: tercer triunfo del año para el piloto de Ecuador, que había ganado las dos de Interlagos. Se volvieron a subir al podio Kensei Matsudaira y Mahdi Salem.<br><img src=\"PRESENTACION/podio_alberto.jpg\" style=\"width:100%;border-radius:12px;margin:14px 0\" alt=\"Alberto Enríquez gana la ronda 6\"><br>Los argentinos tuvieron un avance importante en pista. La única ausencia fue la de Lorenzo Tiberi, lesionado el viernes en entrenamientos (fractura expuesta del dedo meñique de la mano derecha), lamentablemente fuera de competencia por el resto del fin de semana. Santiago Gossa completó las tres carreras: podio de P3, P5 y P7 para el cordobés. Por su parte, Santiago Vogel fue al suelo en la del sábado y el domingo cambió caída por dos finales en el pelotón de punta: P6 y P8 para el piloto de Puerto Rico, Misiones.<br><br>La próxima doble fecha será del 4 al 6 de septiembre en San Juan Villicum, Argentina.<br><br><b>Campeonato (6 de 12) – Top 5</b><br>1. Kensei Matsudaira (USA) – 113<br>2. Alberto Enríquez (ECU) – 94,5<br>3. Andoni Domínguez (NIC) – 78,5<br>4. Mahdi Salem (PLE) – 73,5<br>5. Ulises Weyrauch (PUR) – 56,5"
  },

  {
    fecha: "2026-06-15",
    categoria: "Selección 2027",
    titulo: "Se abre la postulación para el Selection Program 2027",
    bajada: "Los pilotos de 14 a 18 años de toda Latinoamérica ya pueden postular a la Selectiva de noviembre que define la grilla 2027.",
    imagen: "",
    cuerpo: "La Mobil Moto4 Latin Cup abre su proceso de postulación para la temporada 2027. Los pilotos interesados pueden completar el formulario en la sección Postular del sitio oficial. <br><br>La Selectiva se realizará en noviembre de 2026 y de allí saldrá la grilla de la próxima temporada del campeonato oficial FIM Latin America de la categoría Moto4."
  },

  {
    fecha: "2026-04-12",
    categoria: "Resultados",
    titulo: "Dos de dos para Alberto Enríquez en Interlagos",
    bajada: "El ecuatoriano ganó las finales de las fechas 2 y 3 en São Paulo, junto al Moto1000GP.",
    imagen: "PRESENTACION/interlagos_carrera.jpg",
    cuerpo: "El ecuatoriano <b>Alberto Enríquez</b> se impuso en las dos finales del fin de semana en São Paulo: ganó el sábado y el domingo las carreras de las fechas 2 y 3 del Campeonato Moto4 Latin Cup, disputadas en el mítico Autódromo de Interlagos junto al Moto1000GP.<br><img src=\"PRESENTACION/interlagos_grilla.jpg\" style=\"width:100%;border-radius:12px;margin:14px 0\" alt=\"La grilla en Interlagos · foto J. Capreti / MundoPress\"><br><b>Carrera 1 (sábado):</b> Enríquez se adueñó de la final de la Fecha 2. Repitió podio, como en Goiânia, Kensei Matsudaira, y el poleman Murilo Gomes fue tercero. El ganador de Goiás, Andoni Domínguez, terminó cuarto y el argentino Lorenzo Tiberi tuvo un gran rendimiento de menos a más alcanzando el Top 5. En la 9ª ubicación finalizó el misionero Santiago Vogel — cuarto en la qualy — y el paraguayo Torrez cerró dentro del Top 10 en su mejor actuación. Santiago Gossa no pudo terminar la competencia.<br><br><b>Carrera 2 (domingo):</b> lideraba Murilo Gomes pero fue al suelo sin consecuencias. Kensei Matsudaira terminó nuevamente en segunda posición — tercer podio en tres carreras — y por primera vez se subió al tercer escalón Mahdi Salem. Santiago Gossa tuvo una gran carrera en el lote de los cuatro que pelearon la victoria: el cordobés y actual subcampeón terminó cuarto.<br><img src=\"PRESENTACION/interlagos_carrera.jpg\" style=\"width:100%;border-radius:12px;margin:14px 0\" alt=\"El pelotón en Interlagos · foto J. Capreti / MundoPress\"><br>Lorenzo Tiberi y Santiago Vogel finalizaron en el Top 10: séptimo el cordobés tras su quinto puesto del sábado, y octavo el misionero. El ganador de Goiânia, Andoni Domínguez, fue 10°, y Torrez quedó en P11.<br><br>La próxima cita del campeonato será la triple fecha de San Nicolás, Argentina, junto al GP3-CAV."
  },

  {
    fecha: "2026-03-22",
    categoria: "Resultados",
    titulo: "Moto4: victoria de Andoni Domínguez en una carrera sprint en Goiânia",
    bajada: "El nicaragüense ganó la primera fecha 2026, disputada en el fin de semana del Gran Premio de Brasil de MotoGP.",
    imagen: "",
    cuerpo: "Durante el Gran Premio de MotoGP en Goiânia se presentó el Campeonato Moto4 Latin Cup, que tuvo una carrera única el domingo 22 de marzo por la mañana. El cronograma se alteró debido a problemas en la pista brasileña que obligaron a la organización internacional a cancelar la clasificación y la Carrera 1 anunciadas para el sábado 21, por lo que la 1ª fecha válida de 2026 terminó desarrollándose en un único día.<br><br>La carrera duró solamente 4 vueltas de las 16 anunciadas, debido a una bandera roja por el comienzo de la lluvia que se acentuó con la caída del argentino Santiago Vogel.<br><br>Ganó <b>Andoni Domínguez</b> de Nicaragua — ya había sido podio en Termas 2025 —, fue segundo <b>Cristóbal Carreño</b> de Chile y tercero <b>Kensei Matsudaira</b> de Estados Unidos.<br><br>El cierre inesperado de carrera dejó además un 8° puesto final para el cordobés Lorenzo Tiberi en su debut internacional, y el paraguayo Torrez finalizó 11°, en el debut en la categoría pero con experiencia en el Latinoamericano de R3.<br><br>Los argentinos Santiago Vogel y Santiago Gossa protagonizaron caídas en su debut: Gossa al inicio de la carrera, al tocar la rueda trasera de un rival — los estudios confirmaron que el piloto está en perfectas condiciones —; Vogel fue al suelo en la vuelta en que se detuvo la carrera con bandera roja y terminó con un esguince de tobillo izquierdo, en óptima recuperación.<br><br>La siguiente fecha del Moto4 se disputó de manera conjunta con el Moto1000GP en el Autódromo de Interlagos, São Paulo, Brasil."
  }
