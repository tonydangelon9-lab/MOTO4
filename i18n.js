...
(function(){
var D = {
"Visualizaciones de Facebook sumadas en la ventana de cada evento (serie diaria de Meta) + vistas del directo en YouTube. Goiânia (fecha 1, junto a MotoGP™) e Interlagos (fechas 2-3) son anteriores a la ventana de Meta (que empieza el 18 de abril), por lo que no tienen datos de Facebook/Instagram. De Interlagos sí hay directo: 19.400 vistas de las carreras Moto4 en el canal oficial del Moto1000GP (transmisión anfitriona). Ambas se transmitieron además por TV en ESPN Latin America dentro del marco MotoGP™/Moto1000GP — un retorno televisivo cuyo rating no es público. Goiânia, al no tener transmisión libre, se valora principalmente por esa exposición en TV junto al Gran Premio. Las próximas fechas (Villicum 4-6 sept, Santa Cruz do Sul 25-27 sept, Goiânia 4-6 dic) se medirán completas, incluyendo Instagram.":{en:"Facebook views summed within each event's window (Meta daily series) + YouTube live-stream views. Goiânia (round 1, alongside MotoGP™) and Interlagos (rounds 2-3) predate Meta's window (which starts April 18), so they have no Facebook/Instagram data. Interlagos does have a live stream: 19,400 views of the Moto4 races on Moto1000GP's official channel (host broadcast). Both were also aired on TV by ESPN Latin America within the MotoGP™/Moto1000GP framework — a television return whose rating is not public. Goiânia, having no free stream, is valued mainly for that TV exposure alongside the Grand Prix. The next rounds (Villicum Sept 4-6, Santa Cruz do Sul Sept 25-27, Goiânia Dec 4-6) will be measured in full, including Instagram.",pt:"Visualizações do Facebook somadas na janela de cada evento (série diária da Meta) + visualizações da transmissão ao vivo no YouTube. Goiânia (etapa 1, junto à MotoGP™) e Interlagos (etapas 2-3) são anteriores à janela da Meta (que começa em 18 de abril), portanto não têm dados de Facebook/Instagram. Interlagos tem transmissão: 19.400 visualizações das corridas Moto4 no canal oficial da Moto1000GP (transmissão anfitriã). Ambas também foram transmitidas pela TV na ESPN Latin America dentro do quadro MotoGP™/Moto1000GP — um retorno televisivo cujo rating não é público. Goiânia, sem transmissão gratuita, é valorizada principalmente por essa exposição na TV junto ao Grande Prêmio. As próximas etapas (Villicum 4-6 set, Santa Cruz do Sul 25-27 set, Goiânia 4-6 dic) serão medidas por completo, incluindo Instagram."},
...
"10–12 ABR · Moto1000GP":{en:"APR 10–12 · Moto1000GP",pt:"10–12 ABR · Moto1000GP"},
"19–21 JUN · GP3-CAV":{en:"JUN 19–21 · GP3-CAV",pt:"19–21 JUN · GP3-CAV"},
"4–6 SEPT · GP3-CAV":{en:"SEP 4–6 · GP3-CAV",pt:"4–6 SET · GP3-CAV"},
"25–27 SEPT · Moto1000GP":{en:"SEP 25–27 · Moto1000GP",pt:"25–27 SET · Moto1000GP"},
"6–8 NOV · Moto1000GP":{en:"NOV 6–8 · Moto1000GP",pt:"6–8 NOV · Moto1000GP"},
...
"Panel de Datos":{en:"Data Panel",pt:"Painel de Dados"},
...
"Mobil Moto4 Latin Cup — la copa":{en:"Mobil Moto4 Latin Cup — the cup",pt:"Mobil Moto4 Latin Cup — a copa"},
"Ecosistema GP3 Sports":{en:"GP3 Sports ecosystem",pt:"Ecossistema GP3 Sports"},
"Por fin de semana de carrera":{en:"By race weekend",pt:"Por fim de semana de corrida"},
"La comparación trimestral de la copa está influida por el calendario: el trimestre anterior incluyó el debut junto a MotoGP en Goiânia. La unidad correcta de medición es el fin de semana de carrera (ver sección Por carrera).":{en:"The cup's quarter-over-quarter comparison is calendar-driven: the previous quarter included the debut alongside MotoGP in Goiânia. The correct unit of measurement is the race weekend (see By race weekend).",pt:"A comparação trimestral da copa é influenciada pelo calendário: o trimestre anterior incluiu a estreia junto ao MotoGP em Goiânia. A unidade correta de medição é o fim de semana de corrida (ver seção Por corrida)."},
"Visualizaciones de Facebook sumadas en la ventana de cada evento (serie diaria de Meta) + vistas del directo en YouTube. Las próximas fechas (Villicum 4-6 sept, Santa Cruz do Sul 25-27 sept, Goiânia 4-6 dic) se medirán completas, incluyendo Instagram.":{en:"Facebook views summed over each event window (Meta daily series) + YouTube live stream views. Upcoming rounds (Villicum Sep 4-6, Santa Cruz do Sul Sep 25-27, Goiânia Dec 4-6) will be measured in full, including Instagram.",pt:"Visualizações do Facebook somadas na janela de cada evento (série diária da Meta) + vistas da transmissão no YouTube. As próximas etapas (Villicum 4-6 set, Santa Cruz do Sul 25-27 set, Goiânia 4-6 dic) serão medidas completas, incluindo Instagram."},
...
"Acceso reservado. Ingresa el código para continuar.":{en:"Restricted access. Enter the code to continue.",pt:"Acesso reservado. Digite o código para continuar."},
"Entrar":{en:"Enter",pt:"Entrar"},
"Metodología:":{en:"Methodology:",pt:"Metodologia:"},
"los valores provienen de los perfiles públicos y las cuentas administradas, leídos con el mismo método en cada corte. Los números se muestran tal como los publica cada plataforma (redondeados). Las métricas de alcance y visualizaciones se incorporarán al conectar la API de Meta (fase 2). Serie histórica sin ediciones: los cortes anteriores nunca se modifican.":{en:"values come from public profiles and managed accounts, read with the same method at every snapshot. Numbers are shown as each platform publishes them (rounded). Reach and view metrics will be added once the Meta API is connected (phase 2). Unedited historical series: past snapshots are never modified.",pt:"os valores vêm dos perfis públicos e das contas administradas, lidos com o mesmo método em cada corte. Os números são mostrados como cada plataforma os publica (arredondados). As métricas de alcance e visualizações serão adicionadas quando a API da Meta for conectada (fase 2). Série histórica sem edições: os cortes anteriores nunca são modificados."},
"Audiencia total":{en:"Total audience",pt:"Audiência total"},
"seguidores sumados del ecosistema":{en:"combined followers across the ecosystem",pt:"seguidores somados do ecossistema"},
"Material reservado para sponsors y aliados":{en:"Reserved material for sponsors and partners",pt:"Material reservado para patrocinadores e parceiros"},
...
"—la estructura oficial de la FIM y MotoGP Sports Entertainment Group (MotoGP Group) para el desarrollo de pilotos— y respaldada por":{en:"—the official FIM and MotoGP Sports Entertainment Group (MotoGP Group) structure for rider development—and backed by",pt:"—a estrutura oficial da FIM e da MotoGP Sports Entertainment Group (MotoGP Group) para o desenvolvimento de pilotos—e apoiada por"},
", la Moto4 Latin Cup forma parte de la nueva generación de categorías Moto4 que la FIM y MotoGP Group lanzaron a nivel mundial en 2026. Lo que pasa aquí, se ve desde el paddock del Mundial.":{en:", the Moto4 Latin Cup is part of the new generation of Moto4 categories the FIM and MotoGP Group launched worldwide in 2026. What happens here is seen from the World Championship paddock.",pt:", a Moto4 Latin Cup faz parte da nova geração de categorias Moto4 que a FIM e a MotoGP Group lançaram mundialmente em 2026. O que acontece aqui é visto do paddock do Mundial."},
"Todos compiten con la misma máquina de especificación Moto4 con la que MotoGP Group forma campeones en sus copas de promoción de todo el planeta, con neumáticos Pirelli de especificación única. Igualdad total de material: aquí gana el talento, no el presupuesto.":{en:"Everyone races the same Moto4-specification machine MotoGP Group uses to develop champions in its promotional cups around the world, on single-specification Pirelli tyres. Total equality of machinery: here talent wins, not budget.",pt:"Todos competem com a mesma máquina de especificação Moto4 com a qual a MotoGP Group forma campeões em suas copas de promoção pelo mundo, com pneus Pirelli de especificação única. Igualdade total de material: aqui vence o talento, não o orçamento."},
"asciende como piloto titular del":{en:"moves up as a full-time rider for",pt:"assume como piloto titular do"},
", nuestro equipo oficial con base en Barcelona, para disputar la":{en:", our official team based in Barcelona, to race in the",pt:", nossa equipe oficial baseada em Barcelona, para disputar a"},
...
"Paso 5 · Opcional":{en:"Step 5 · Optional",pt:"Passo 5 · Opcional"},
"Paso 6":{en:"Step 6",pt:"Passo 6"},
...
"Tu material audiovisual (opcional)":{en:"Your photos & videos (optional)",pt:"Seu material audiovisual (opcional)"},
"Este paso NO es obligatorio.":{en:"This step is NOT required.",pt:"Esta etapa NÃO é obrigatória."},
"Si tienes videos o fotos, súbelos a Google Drive o YouTube y pega el enlace (verifica que se abra sin permisos). Si no tienes nada ahora, sigue igual: si quedas preseleccionado te pediremos videos de pista más adelante.":{en:"If you have videos or photos, upload them to Google Drive or YouTube and paste the link (make sure it opens without permission issues). If you don't have anything yet, keep going: if you're shortlisted, we'll ask you for track videos later.",pt:"Se você tiver vídeos ou fotos, envie-os para o Google Drive ou YouTube e cole o link (verifique se abre sem restrições de permissão). Se não tiver nada agora, continue mesmo assim: se você for pré-selecionado, pediremos vídeos de pista mais adiante."},
"Video de presentación (opcional)":{en:"Introduction video (optional)",pt:"Vídeo de apresentação (opcional)"},
"Cuenta quién eres, tu recorrido y por qué quieres entrar. Máximo 2 minutos.":{en:"Tell us who you are, your background, and why you want to join. Maximum 2 minutes.",pt:"Conte quem você é, sua trajetória e por que quer entrar. Máximo de 2 minutos."},
"Video en pista (opcional)":{en:"On-track video (optional)",pt:"Vídeo na pista (opcional)"},
"Onboard o filmado desde afuera. Es lo que más miran los seleccionadores.":{en:"Onboard footage or filmed from outside. This is what the selectors look at most.",pt:"Onboard ou filmado de fora. É o que mais os selecionadores olham."},
"Fotos (link, opcional)":{en:"Photos (link, optional)",pt:"Fotos (link, opcional)"},
"PDF de resultados (link, opcional)":{en:"Results PDF (link, optional)",pt:"PDF de resultados (link, opcional)"},
