...
(function(){
var D = {
"Visualizaciones de Facebook sumadas en la ventana de cada evento (serie diaria de Meta) + vistas del directo en YouTube. Goiânia (fecha 1, junto a MotoGP™) e Interlagos (fechas 2-3) quedan sin métricas digitales propias: son anteriores a la ventana de medición de Meta (que empieza el 18 de abril) y no tuvieron directo en el canal propio, pero se transmitieron por TV en ESPN Latin America dentro del marco MotoGP™/Moto1000GP — su retorno principal fue la exposición televisiva. Las próximas fechas (Villicum 4-6 sept, Santa Cruz do Sul 25-27 sept, Cuiabá 6-8 nov) se medirán completas, incluyendo Instagram.":{en:"Facebook views summed within each event's window (Meta daily series) + YouTube live-stream views. Goiânia (round 1, alongside MotoGP™) and Interlagos (rounds 2-3) have no own digital metrics: they predate Meta's measurement window (which starts April 18) and had no stream on the own channel, but they were broadcast on TV by ESPN Latin America within the MotoGP™/Moto1000GP framework — their main return was television exposure. The next rounds (Villicum Sept 4-6, Santa Cruz do Sul Sept 25-27, Cuiabá Nov 6-8) will be measured in full, including Instagram.",pt:"Visualizações do Facebook somadas na janela de cada evento (série diária da Meta) + visualizações da transmissão ao vivo no YouTube. Goiânia (etapa 1, junto à MotoGP™) e Interlagos (etapas 2-3) ficam sem métricas digitais próprias: são anteriores à janela de medição da Meta (que começa em 18 de abril) e não tiveram transmissão no canal próprio, mas foram transmitidas pela TV na ESPN Latin America dentro do quadro MotoGP™/Moto1000GP — seu retorno principal foi a exposição televisiva. As próximas etapas (Villicum 4-6 set, Santa Cruz do Sul 25-27 set, Cuiabá 6-8 nov) serão medidas por completo, incluindo Instagram."},
